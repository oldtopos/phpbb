...
namespace summitworkshops\workshops\event;
...
/**
 * Summit Workshops Event listener.
 */
class main_listener implements EventSubscriberInterface
{
	...
	public function load_language_on_setup($event)
	{
		...
		$lang_set_ext[] = [
			'ext_name' => 'summitworkshops/workshops',
			'lang_set' => 'common',
		];
	...
	/**
	 * Show users viewing Summit Workshops page on the Who Is Online page
	 *
	 * @param \phpbb\event\data	$event	Event object
	 */
	public function viewonline_page($event)
	{
		...
		{
			$event['location'] = $this->language->lang('VIEWING_SUMMITWORKSHOPS_WORKSHOPS');
			$event['location_url'] = $this->helper->route('summitworkshops_workshops_controller', ['name' => 'world']);
		}
	}
	...
	public function display_forums_modify_template_vars($event)
	{
		...
		$forum_row['FORUM_NAME'] .= $this->language->lang('WORKSHOPS_EVENT');
