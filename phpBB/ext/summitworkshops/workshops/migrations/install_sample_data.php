...
class install_sample_data extends \phpbb\db\migration\migration
{
	...
	{
		return $this->config->offsetExists('summitworkshops_workshops_sample_int');
	}
	...
	public function update_data()
	{
		return [
			...
			['config.add', ['summitworkshops_workshops_sample_int', 0]],
			['config.add', ['summitworkshops_workshops_sample_str', '']],

			// Add a new config_text table setting
			['config_text.add', ['summitworkshops_workshops_sample', '']],

			// Add new permissions
			['permission.add', ['a_new_summitworkshops_workshops']], // New admin permission
			['permission.add', ['m_new_summitworkshops_workshops']], // New moderator permission
			['permission.add', ['u_new_summitworkshops_workshops']], // New user permission
			...
			['permission.permission_set', ['ROLE_ADMIN_FULL', 'a_new_summitworkshops_workshops']], // Give ROLE_ADMIN_FULL a_new_summitworkshops_workshops permission
			['permission.permission_set', ['ROLE_MOD_FULL', 'm_new_summitworkshops_workshops']], // Give ROLE_MOD_FULL m_new_summitworkshops_workshops permission
			['permission.permission_set', ['ROLE_USER_FULL', 'u_new_summitworkshops_workshops']], // Give ROLE_USER_FULL u_new_summitworkshops_workshops permission
			['permission.permission_set', ['ROLE_USER_STANDARD', 'u_new_summitworkshops_workshops']], // Give ROLE_USER_STANDARD u_new_summitworkshops_workshops permission
			['permission.permission_set', ['REGISTERED', 'u_new_summitworkshops_workshops', 'group']], // Give REGISTERED group u_new_summitworkshops_workshops permission
			['permission.permission_set', ['REGISTERED_COPPA', 'u_new_summitworkshops_workshops', 'group', false]], // Set u_new_summitworkshops_workshops to never for REGISTERED_COPPA

			// Add new permission roles
			['permission.role_add', ['workshops admin role', 'a_', 'a new role for admins']], // New role "workshops admin role"
			['permission.role_add', ['workshops moderator role', 'm_', 'a new role for moderators']], // New role "workshops moderator role"
			['permission.role_add', ['workshops user role', 'u_', 'a new role for users']], // New role "workshops user role"
